...
- DNS, certificate authorities, the NLA service, npm registry, and official Node and distroless image publication remain trusted dependencies. Digest and lockfile updates still require review and rescanning.
